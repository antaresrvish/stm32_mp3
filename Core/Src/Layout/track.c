...
void Track_Init_UI(char track_val[], char artist_val[]) {
  ssd1306_Init();
  ssd1306_DrawBitmap(111, 0, info_battery, 16, 8, WHITE);
  ...
  ssd1306_DrawBitmap(0, 2, track_music, 8, 8, WHITE);

  ssd1306_ScrollInit(&track_lbl, 10, 0, 14, Font_7x10);
  ssd1306_ScrollWrite(&track_lbl, track_val);
  ssd1306_DrawBitmap(0, 12, track_artist, 8, 8, WHITE);

  ssd1306_ScrollInit(&artist_lbl, 10, 12, 14, Font_7x10);
